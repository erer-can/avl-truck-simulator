...
public class FileComparator {
    ...
    public static void main(String[] args) {
        ...
        String filePath1 = "test_cases-updated/outputs/output.txt"; // Replace with your first file path
        String filePath2 = "test_cases-updated/outputs/type5-small.txt"; // Replace with your second file path
